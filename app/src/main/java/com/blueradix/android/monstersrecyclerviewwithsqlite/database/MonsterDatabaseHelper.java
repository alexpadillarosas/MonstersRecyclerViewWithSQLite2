...
public class MonsterDatabaseHelper extends SQLiteOpenHelper {
    ...
    //TODO: create a query to get a monster when passing the ID. Call it: GET_MONSTER_BY_ID
    ...
    /**
     *  This method adds a monster to out database
     * @param name
     * @param description
     * @param scariness
     * @return the autogenerated ID (primary key) of the newly inserted monster
     */
